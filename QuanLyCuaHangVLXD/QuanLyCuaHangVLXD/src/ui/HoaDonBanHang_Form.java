...
public class HoaDonBanHang_Form extends JFrame {
...
//        a.setPreferredSize(new Dimension());
        ...
        a1.add(lblgth = new JLabel("- CHUYÊN CUNG CẤP CÁC LOẠI ĐỒ BẢO HỘ LAO ĐỘNG "));
        ...
        a3.add(lblgth = new JLabel("- Website: Dobaoho.com.vn | Fanpage: fb.com/Dobaoho"));
        a.add(Box.createVerticalStrut(5));
...
//        bCen.add(Box.createVerticalStrut(5));
        ...
        bCen4.add(lblKhachHang = new JLabel("Khách Hàng:"));
...
//        bCen.add(Box.createVerticalStrut(5));
        ...
        CT_HDBH_DAO cthdbhDao = new CT_HDBH_DAO();
        List<VatLieu> ds = new ArrayList<>();
        VatLieu_TableModel tableModel1 = new VatLieu_TableModel(ds);
...
//        bCen.add(Box.createVerticalStrut(5));
        ...
        bc2.add(Box.createHorizontalStrut(250));
        bc2.add(lblKhachTra = new JLabel("Tiền Khách Trả:"));
        bc2.add(Box.createHorizontalStrut(10));
        bc2.add(txtKhachTra = new JTextField());
//        bCen.add(Box.createVerticalStrut(5));
        bc.add(bc3 = Box.createHorizontalBox());
        bc3.add(Box.createHorizontalStrut(250));
        bc3.add(lblTienThua = new JLabel("Tiền Trả Lại:"));
        bc3.add(Box.createHorizontalStrut(10));
        bc3.add(txtTienThua = new JTextField());
//        bCen.add(Box.createVerticalStrut(5));
...
//        bCen.add(Box.createVerticalStrut(5));
        ...
        lblTongTien.setPreferredSize(lblKhachTra.getPreferredSize());
        lblTienThua.setPreferredSize(lblKhachTra.getPreferredSize());
        lblTienBangChu.setPreferredSize(lblKhachTra.getPreferredSize());
        lblGhiChu.setPreferredSize(lblKhachTra.getPreferredSize());
        ...
        txtKhachTra.setText(String.valueOf(df.format(tienKhach)));
        String tienThua = String.valueOf(df.format(tienKhach - tong));
        ...
        bs.add(lblBan = new JLabel("Người Bán Hàng"));
        bs.add(Box.createHorizontalStrut(150));
        bs.add(lblThuNgan = new JLabel("Thu Ngân"));
        bs.add(Box.createHorizontalStrut(150));
        bs.add(lblKhach = new JLabel("Khách Hàng"));
        ...
        HoaDonBanHang hdbh = bhDao.TimKiemMa(maHD);
        txtMaHD.setText(maHD);
        txtNgayXuat.setText(hdbh.getNgayLapHD().toString());
        txtNguoilap.setText(hdbh.getNhanVien().getTenNV());
        txtKhachHang.setText(hdbh.getKhachHang().getTenKH());
        txtSoDT.setText(hdbh.getKhachHang().getDienThoai());
        txtDiaChi.setText(hdbh.getKhachHang().getDiaChi());
        table1.setModel(new VatLieu_TableModel(cthdbhDao.TimKiemVatLieuByMaHD(maHD)));
